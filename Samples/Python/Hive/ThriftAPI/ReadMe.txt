#Steps to run Hive Gradle samples through Python Thrift API

*Gradle in command line
Open BigData command shell, type 
To build : gradle -p %SYNCBDP_HOME%\Samples\Python\Hive\ThriftAPI build
To run : gradle -p %SYNCBDP_HOME%\Samples\Python\Hive\ThriftAPI runPy -Parguments="ipaddress portNo"
...
Ex: runPy -Parguments="192.168.10.12 10000"
...
(Note: To run the hive samples locally type runPy -Parguments="localhost 10000" )