#Steps to run Oozie Gradle samples through REST API
...
To build : 
	gradle -p %SYNCBDP_HOME%\Samples\Java\Oozie\RESTAPI build
To run : 

No Authentication:
	gradle -p %SYNCBDP_HOME%\Samples\Java\Oozie\RESTAPI run -Parguments="Hostname"
	
KERBEROS Authentication:
	gradle -p %SYNCBDP_HOME%\Samples\Java\Oozie\RESTAPI run -Parguments="Hostname kerberos"
...
To run : Right click on the project click Custom Tasks-> Custom Tasks
             ...
             Under 'Arguments' type 'For KERBEROS => -Parguments="HostName AuthenticationType"
...
For KERBEROS=> Under 'Arguments' tab, in Program arguments select 'Use' and type '-Parguments="HostName AuthenticationType"
...
Under 'Command line',
        ...
        To run : 
For KERBEROS=>		run -Parguments="HostName AuthenticationType"
