...
To build : 
	gradle -p %SYNCBDP_HOME%\Samples\Java\Oozie\JavaAPI build
To run : 

No Authentication:
	gradle -p %SYNCBDP_HOME%\Samples\Java\Oozie\JavaAPI run -Parguments="Hostname"
	
KERBEROS Authentication:
	gradle -p %SYNCBDP_HOME%\Samples\Java\Oozie\JavaAPI run -Parguments="Hostname kerberos"
