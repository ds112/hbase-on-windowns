...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Sqoop\JavaAPI\SqoopJavaImport build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Sqoop\JavaAPI\SqoopJavaImport run
...
(Note: In SqoopImportJob.java file replace the connectionString, databaseName, tableName, userName and password corresponding to your Database)