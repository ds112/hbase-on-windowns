...
To build : 
	gradle -p %SYNCBDP_HOME%\Samples\Java\Hive\ThriftJDBC\Recommend build
To run : 

No Authentication:
	gradle -p %SYNCBDP_HOME%\Samples\Java\Hive\ThriftJDBC\Recommend runJar -Parguments="HostName"
	
KERBEROS Authentication:
	gradle -p %SYNCBDP_HOME%\Samples\Java\Hive\ThriftJDBC\Recommend runJar -Parguments="HostName kerberos <username> <password>"
