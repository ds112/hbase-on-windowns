...
To build : 
	gradle -p %SYNCBDP_HOME%\Samples\Java\Hive\ThriftJDBC\CreateTable build
To run : 

No Authentication:
	gradle -p %SYNCBDP_HOME%\Samples\Java\Hive\ThriftJDBC\CreateTable runJar -Parguments="HostName"
	
KERBEROS Authentication:
	gradle -p %SYNCBDP_HOME%\Samples\Java\Hive\ThriftJDBC\CreateTable runJar -Parguments="HostName kerberos <username> <password>"
