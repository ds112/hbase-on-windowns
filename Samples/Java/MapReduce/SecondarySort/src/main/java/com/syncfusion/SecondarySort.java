	 ...
	 /**
	  ...
	  public static void main(String[] args) throws Exception {
		String [] arguments =new String[2];
		  ...
		  arguments[0] = "hdfs://"+args[0]+":9000/Data/Spark/MLLib/Sample_LDA_Data.txt";
		  arguments[1] = "hdfs://"+args[0]+":9000/secondarySortOutput";
		    int res = ToolRunner.run(new Configuration(), new SecondarySort(), arguments);
		    System.exit(res);
	  }
