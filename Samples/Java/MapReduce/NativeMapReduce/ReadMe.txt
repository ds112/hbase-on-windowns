...
Pre-requisites to submit jobs in Secure Cluster through Big Data Command Shell form the BigData Dashboard.
 ...
 5. Replace the following line [41] into the "build.gradle" file.
		commandLine 'cmd', '/c', "$syncfusionHadoopSDKPath/bin/hadoop --config <Secured-hadoop-conf-directory> jar $projectDir/build/libs/NativeMapReduce.jar $arguments"
...
To build : 
	gradle -p %SYNCBDP_HOME%\Samples\Java\MapReduce\NativeMapReduce build
To run : 
	gradle -p %SYNCBDP_HOME%\Samples\Java\MapReduce\NativeMapReduce runJar  -Parguments="aggregatewordcount /Data/WarPeace.txt /AWC 2 textinputformat"
...
To run : Right click on the project click Custom Tasks-> Custom Tasks
             ...
             Under 'Arguments' type '-Parguments="aggregatewordcount /Data/WarPeace.txt /AWC 2 textinputformat"
...
To run :  Right click the project, click Run As-> Gradle Build.
              ...
              Under 'Arguments' tab, in Program arguments select 'Use' and type '-Parguments="aggregatewordcount /Data/WarPeace.txt /AWC 2 textinputformat""
...
Under 'Command line',
        ...
        To run : run -Parguments="aggregatewordcount /Data/WarPeace.txt /AWC 2 textinputformat"
Click OK to run the sample.

(Note: To get the list of HDFS samples available type run -Parguments="help"; To run the HDFS samples locally type run -Parguments="aggregatewordcount /Data/WarPeace.txt /AWC 2 textinputformat")
