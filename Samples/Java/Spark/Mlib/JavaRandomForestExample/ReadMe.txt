...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\Mlib\JavaRandomForestExample build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\Mlib\JavaRandomForestExample run
