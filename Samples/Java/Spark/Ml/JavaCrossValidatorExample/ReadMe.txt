...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\Ml\JavaCrossValidatorExample build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\Ml\JavaCrossValidatorExample run
