#Steps to run Spark Gradle samples through Java API

*Gradle in command line
Open BigData command shell, type 
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\Ml\JavaSimpleTextClassificationPipeline build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\Ml\JavaSimpleTextClassificationPipeline run
