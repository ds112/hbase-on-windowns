...
public class JavaSimpleTextClassificationPipeline {
  ...
  public static void main(String[] args) {
    SparkSession spark = SparkSession.builder().master("local").appName("JavaSimpleTextClassificationPipeline").config("spark.sql.warehouse.dir","/user/hive/warehouse").getOrCreate();
