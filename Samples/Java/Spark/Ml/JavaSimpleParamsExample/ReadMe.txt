...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\Ml\JavaSimpleParamsExample build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\Ml\JavaSimpleParamsExample run
