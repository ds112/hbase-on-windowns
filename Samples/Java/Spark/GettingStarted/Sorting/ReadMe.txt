...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\Sorting build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\Sorting run
