...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\FindReplace build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\FindReplace run
