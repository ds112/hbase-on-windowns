...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\WordCount build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\WordCount run
