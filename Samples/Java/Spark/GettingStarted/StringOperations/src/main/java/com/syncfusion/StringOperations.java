...
public final class StringOperations {
    public static void main(String[] args) throws Exception {
		...
		SparkConf sparkConf = new SparkConf().setAppName("StringOperations");
		...
		// Creates the Key-Value pair with the Internet Address, date as key corresponding count as value
        ...
        counts.saveAsTextFile(cluster + "/Data/Output/StringOperationsJava");
        ctx.stop();
		}
