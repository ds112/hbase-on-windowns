...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\StringOperations build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\StringOperations run
