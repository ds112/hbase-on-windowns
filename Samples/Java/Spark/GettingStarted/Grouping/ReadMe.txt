...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\Grouping build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\Grouping run
