...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\DateTime build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\DateTime run
