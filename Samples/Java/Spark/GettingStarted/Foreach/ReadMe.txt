...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\Foreach build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\GettingStarted\Foreach run
