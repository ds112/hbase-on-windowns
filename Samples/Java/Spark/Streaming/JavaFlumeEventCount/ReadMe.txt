...
To build : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\Streaming\JavaFlumeEventCount build
To run : gradle -p %SYNCBDP_HOME%\Samples\Java\Spark\Streaming\JavaFlumeEventCount run
