...
To build : 
	gradle -p %SYNCBDP_HOME%\Samples\Java\HDFS\JavaAPI build
To run : 

No Authentication:
	gradle -p %SYNCBDP_HOME%\Samples\Java\HDFS\JavaAPI runJar -Parguments="HostName OperationType"
	
KERBEROS Authentication:
	gradle -p %SYNCBDP_HOME%\Samples\Java\HDFS\JavaAPI runJar -Parguments="HostName OperationType kerberos"
