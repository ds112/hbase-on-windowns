namespace LinearRegressionModel
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "This sample demonstrate the usage of PMML execution engine for prediction based on the existing dataset and PMML file using LinearRegressionModel.";
            // 
