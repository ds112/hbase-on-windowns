...
<asp:Content ID="Content5" ContentPlaceHolderID="ControlsSection" runat="server">
   ...
   <div class="samplecontainer" runat="server" id="Sample">
        ...
        <Columns>
            <ej:Column Field="0" HeaderText="field_0" TextAlign="Center" Width="150" />
            <ej:Column Field="1" HeaderText="field_1" TextAlign="Center" Width="150" />
            <ej:Column Field="2" HeaderText="field_2" TextAlign="Center" Width="150" />
            <ej:Column Field="3" HeaderText="Predicted" TextAlign="Center" Width="150" CssClass="predictedColumnColor"/>
        </Columns>
        <ScrollSettings Height="300" Width="930"></ScrollSettings>
                        ...
                        <ej:TabItem Id="spark" Text="Spark" >
                             <ContentSection>
                              <div class="tab_height">
                                     <pre id="sparkCode" class="brush: csharp;"/> 
                                </div>
