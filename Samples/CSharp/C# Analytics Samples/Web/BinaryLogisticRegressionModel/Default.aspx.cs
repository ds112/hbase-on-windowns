...
namespace WebSampleBrowser.BinaryLogisticRegressionModel
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void BindDataSource()
        {
            ...
            String pmmlPath = string.Format("{0}{1}.pmml", path + "../../../Models/BinaryLogisticRegressionModel/", "sample_libsvm_data");
            String sourcePath = string.Format("{0}{1}.aspx.cs", path + "../../../BinaryLogisticRegressionModel/", "Default");
            String sparkPath = string.Format("{0}{1}.scala", path + "../../../Models/BinaryLogisticRegressionModel/", "Spark");
