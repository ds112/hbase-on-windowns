<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="Default.aspx.cs" Inherits="WebSampleBrowser.LassoModel.Default" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ControlsSection" runat="server">  
          ...
          <p>
    <strong>This sample demonstrate the usage of PMML execution engine for prediction based on the existing dataset and PMML file using Lasso Model.</strong>
</p>
