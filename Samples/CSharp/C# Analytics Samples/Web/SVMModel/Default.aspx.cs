...
namespace WebSampleBrowser.SVMModel
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void BindDataSource()
        {
            ...
            SVM outputData = new SVM();
            String path = Request.PhysicalPath;
            Datasource = outputData.list(path);
            this.FlatGrid.DataSource = Datasource;
            this.FlatGrid.DataBind();
            Model data = new Model();
            String pmmlPath = string.Format("{0}{1}.pmml", path + "../../../Models/SVMModel/", "sample_libsvm_data");
            String sourcePath = string.Format("{0}{1}.aspx.cs", path + "../../../SVMModel/", "Default");
            String sparkPath = string.Format("{0}{1}.scala", path + "../../../Models/SVMModel/", "Spark");
