...
{
    public class RidgeRegressionModelController : Controller
    {
        //
        // GET: /StronglyBinded/
      
        public ActionResult RidgeRegressionModelDefault()
        {
            ...
            ViewBag.source = System.IO.File.ReadAllText(path + "../../../Controllers/RidgeRegressionModel/RidgeRegressionModelController.cs");
            ViewBag.spark = System.IO.File.ReadAllText(path + "../../../Models/RidgeRegressionModel/Spark.scala");
            ViewBag.PMML = System.IO.File.ReadAllText(path + "../../../Models/RidgeRegressionModel/lpsa.pmml");
            return View();
        }
