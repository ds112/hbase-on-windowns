...
{
    public class SVMModelController : Controller
    {

        public ActionResult SVMModelDefault()
        {
            List<List<String>> Datasource = new List<List<String>>();
            SVMModel outputData = new SVMModel();
            String path = Request.PhysicalPath;
            Datasource = outputData.list(path);
            ViewBag.datasource = Datasource;
            ViewBag.source = System.IO.File.ReadAllText(path + "../../../Controllers/SVMModel/SVMModelController.cs");
            ViewBag.spark = System.IO.File.ReadAllText(path + "../../../Models/SVMModel/Spark.scala");
            ViewBag.pmml = System.IO.File.ReadAllText(path + "../../../Models/SVMModel/sample_libsvm_data.pmml");
            return View();
    ...
    public class SVMModel
    {
        ...
        {
            //Create instance
            SVMModel program = new SVMModel();
            string[] Lines = System.IO.File.ReadAllLines(path + "../../../Models/SVMModel/sample_libsvm_data.txt");
            program.outputTable = program.PredictResult(Lines, path + "../../../Models/SVMModel/sample_libsvm_data.pmml");
