...
namespace MVCSampleBrowser.Controllers
{
        ...
        public ActionResult ExportDefault(string SaveOption)
        {
            ...
            else if (SaveOption == "Excel 2013" || SaveOption == "Excel 2010" || SaveOption == "Excel 2007" || SaveOption == "Excel 2003" || SaveOption == "CSV")
            {
                ...
                try
                {
                    ...
                    var result = CustomersData.list(path);
                    ErrorMessage = null;

                    //Adding header text for worksheet
                    worksheet[1, 1].Text = "ContactId";
                    worksheet[1, 2].Text = "info:FullName";
                    worksheet[1, 3].Text = "info:Age";
                    worksheet[1, 4].Text = "contact:EmailId";
                    worksheet[1, 5].Text = "contact:PhoneNo";
                    worksheet[1, 6].Text = "other:ModifiedDate";
                    

                    int i = 1;
                    //Reading each row from the fetched result
                    foreach (Customers records in result)
                    {
                        ...
                        worksheet[i + 1, 4].Text = records.EmailId;
                        worksheet[i + 1, 5].Text = records.PhoneNumber;
    ...
    #endregion DocIOExtension

    #endregion XlsIOExtension