    ...
    public partial class Form1 : MetroForm
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    gridGroupingControl1.DataSource = RowFilter;
                    ...
                    gridGroupingControl1.TableDescriptor.Name = "No Records to display";
        ...
        private void RowFIilter_Click(object sender, EventArgs e)
        {
            gridGroupingControl1.DataSource = RowFilter;
        }

        private void SingleColumn_Click(object sender, EventArgs e)
        {
            gridGroupingControl1.DataSource = SingleColumnValueFilter;
        }
