...
{
    //WordCount Operation.
    //Implementation of WordCount operations in native MapReduce through C#.
    ...
    class Program
    {
        ...
        #endregion
        public class WordCountMR : HadoopJob<SimpleMapper, SimpleReducer, SimpleReducer>
        {
        ...
        public static void DoCustomMapReduce()
        {
            ...
            hadoop.StorageSystem.WriteAllText(WordCountMR._input1HDFS, fileStream);
            Console.WriteLine("Input file uploaded.......\n\n");
            Console.WriteLine("WordCount Operation.\n\nImplementation of WordCount operations in native MapReduce through C#.");
            Console.WriteLine("Execution begins......\n");

            //connect to HDInsightcluster      
            MapReduceResult result = hadoop.MapReduceJob.ExecuteJob<WordCountMR>();
            Console.WriteLine();
