...
{
    //Sorting.
    //Sample demonstrating Sorting of items in native MapReduce through C#.

    class Program
    {
        #region Variables
        //static WebRequest getUrl;
        //static Stream objStream; static string[] arrayMapperExecCount = new string[100000];
        //static int countVariable = 0;
        static string uName;
        #endregion
        public class SortingMR : HadoopJob<SimpleMapper, SimpleReducer, SimpleReducer>
        {
        ...
        public class SimpleMapper : MapperBase
        {
            public override void Map(string inputLine, MapperContext context)
            {
                ...
                if (split_input.Count > 1)
                {
                    ...
                    if (!string.IsNullOrEmpty(split_input[0]))
                    {
        ...
        public static void DoCustomMapReduce()
        {
            ...
            hadoop.StorageSystem.WriteAllText(SortingMR._input1HDFS, fileStream);
            Console.WriteLine("Input file uploaded.......\n\n");
            Console.WriteLine("Sorting.\n\nSample demonstrating sorting of items in native MapReduce through C#.. \n\n.");
            Console.WriteLine("Execution begins......\n");

            //connect to HDInsightcluster      
            MapReduceResult result = hadoop.MapReduceJob.ExecuteJob<SortingMR>();
            Console.WriteLine();
