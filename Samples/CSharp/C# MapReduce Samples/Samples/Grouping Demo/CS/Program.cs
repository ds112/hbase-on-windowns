...
{
    //Grouping Operation.
    //Implementation of Grouping  operation in native MapReduce through C#. 
    ...
    class Program
    {
        ...
        #endregion
        public class GroupingMR : HadoopJob<SimpleMapper, SimpleReducer, SimpleReducer>
        {
        ...
        public class SimpleMapper : MapperBase
        {
            public override void Map(string inputLine, MapperContext context)
            {
                ...
                if (split_input.Count > 1)
                {
                    ...
                    // Emit host name : Date as key with entire record separated by \t
                    context.EmitKeyValue("(" + split_input[0] + "," + date.Date.ToShortDateString() + ")" + "\t", val);
                }
            }
        }
        ...
        public static void DoCustomMapReduce()
        {
            ...
            hadoop.StorageSystem.WriteAllText(GroupingMR._input1HDFS, fileStream);
            ...
            MapReduceResult result = hadoop.MapReduceJob.ExecuteJob<GroupingMR>();
            Console.WriteLine();
