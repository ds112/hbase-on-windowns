...
{
   // Regex Operation.
    //Implementation of String Regex operations in native MapReduce through C#. 
    //Using NASA-HTTP data,Emit the http error values that matches the error return code '200' in the each column value
    ...
    class Program
    {
        ...
        #endregion
        public class RegexMR : HadoopJob<SimpleMapper, SimpleReducer, SimpleReducer>
        {
 ...
 public class SimpleMapper : MapperBase
    ...
    public class SimpleReducer : ReducerCombinerBase
    {
        ...
        public static void DoCustomMapReduce()
        {
            ...
            hadoop.StorageSystem.WriteAllText(RegexMR._input1HDFS, fileStream);
            Console.WriteLine("Input file uploaded.......\n\n");
            Console.WriteLine("Regex Operation.\n\nImplementation of String Regex operations in native MapReduce through C#. \n\nResult :Using NASA-HTTP data,Emit the http error values that matches the error return code '200' in the each column value");
            Console.WriteLine("Execution begins......\n");

            //connect to HDInsightcluster      
            MapReduceResult result = hadoop.MapReduceJob.ExecuteJob<RegexMR>();
            Console.WriteLine();
