...
{
    //Foreach Statement.
    //Implementation of  Foreach Statement operations in native MapReduce through C#
    ...
    class Program
    {
        ...
        public class ForEachStatementMR : HadoopJob<SimpleMapper, SimpleReducer, SimpleReducer>
        {
        ...
        public static void DoCustomMapReduce()
        {
            ...
            hadoop.StorageSystem.WriteAllText(ForEachStatementMR._input1HDFS, fileStream);
            ...
            MapReduceResult result = hadoop.MapReduceJob.ExecuteJob<ForEachStatementMR>();
            Console.WriteLine();
