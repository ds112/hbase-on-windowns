...
{
    //Search By Keyword.
    //Implementation of  Searching operation by Keyword in native MapReduce through C#
    //Result : Emit the values that matches the keyword.
    ...
    class Program
    {
        ...
        public class SearchMR : HadoopJob<SimpleMapper, SimpleReducer, SimpleReducer>
        {
        ...
        public static void DoCustomMapReduce()
        {
            ...
            hadoop.StorageSystem.WriteAllText(SearchMR._input1HDFS, fileStream);
            ...
            MapReduceResult result = hadoop.MapReduceJob.ExecuteJob<SearchMR>();
            Console.WriteLine();
