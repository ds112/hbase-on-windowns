...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\Ml\CrossValidatorExample build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\Ml\CrossValidatorExample run
