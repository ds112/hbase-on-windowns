...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\Graphx\Analytics\PageRank build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\Graphx\Analytics\PageRank run
