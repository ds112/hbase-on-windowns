...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\StringOperations build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\StringOperations run
