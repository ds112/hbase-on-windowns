...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\DateTime build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\DateTime run
