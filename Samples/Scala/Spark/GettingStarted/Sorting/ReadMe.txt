...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\Sorting build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\Sorting run
