...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\Regex build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\Regex run
