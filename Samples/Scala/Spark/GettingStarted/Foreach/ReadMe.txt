...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\Foreach build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\Foreach run
