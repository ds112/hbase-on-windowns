...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\Graphx\SynthBenchmark\PageRank build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\Graphx\SynthBenchmark\PageRank run
