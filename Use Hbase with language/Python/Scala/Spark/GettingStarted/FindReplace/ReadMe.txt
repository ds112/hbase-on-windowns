...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\FindReplace build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\FindReplace run
