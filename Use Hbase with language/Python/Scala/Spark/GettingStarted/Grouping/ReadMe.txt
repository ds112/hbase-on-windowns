...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\Grouping build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\Grouping run
