...
To build : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\WordCount build
To run : gradle -p %SYNCBDP_HOME%\Samples\Scala\Spark\GettingStarted\WordCount run
