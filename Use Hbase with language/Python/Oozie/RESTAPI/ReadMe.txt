#Steps to run Oozie Gradle samples through Python REST API

*Gradle in command line
Open BigData command shell, type 
To build : gradle -p %SYNCBDP_HOME%\Samples\Python\Oozie\RESTAPI build
To run : gradle -p %SYNCBDP_HOME%\Samples\Python\Oozie\RESTAPI runPy -Parguments="ipaddress"
...
To run : Right click on the project click Custom Tasks-> Custom Tasks
             ...
             Under 'Arguments' type '-Parguments="ipaddress"
             Click Execute to run the sample.
Ex: runPy -Parguments="192.168.10.12"
...
To run :  Right click the project, click run As-> Gradle Build.
              ...
              Under 'Arguments' tab, in Program arguments select 'Use' and type '-Parguments="ipaddress"
...
Under 'Command line',
        ...
        To run : runPy -Parguments="ipaddress"
Click OK to run the sample.

(Note: To run the Oozie samples locally type runPy -Parguments="localhost")